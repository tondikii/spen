export const DEFAULT_WEB_URL = 'http://localhost:8081';
...
export function getPublicDocumentUrl(path: PublicDocumentPath, webUrl = process.env.EXPO_PUBLIC_WEB_URL ?? DEFAULT_WEB_URL) {
