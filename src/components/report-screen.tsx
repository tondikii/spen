...
const styles = StyleSheet.create({ page: { flex: 1 }, content: { padding: 21, paddingBottom: 40 }, header: { alignItems: 'flex-start', flexDirection: 'row', justifyContent: 'space-between', marginBottom: 24 }, eyebrow: { ...Typography.eyebrow }, insightButton: { borderRadius: Radius.pill, borderWidth: 1, marginTop: 14, paddingHorizontal: 12, paddingVertical: 10 }, summary: { borderRadius: 19, borderWidth: 1, flexDirection: 'row', justifyContent: 'space-between', marginBottom: 17, padding: 14 }, metric: { gap: 5 }, card: { borderRadius: 22, borderWidth: 1, marginBottom: 14, padding: 17 }, donutRow: { flexDirection: 'row', gap: 17, marginTop: 18 }, donut: { alignItems: 'center', borderRadius: 70, borderWidth: 13, height: 135, justifyContent: 'center', width: 135 }, legend: { flex: 1, justifyContent: 'center' }, legendRow: { alignItems: 'center', flexDirection: 'row', gap: 7, paddingVertical: 7 }, dot: { borderRadius: 4, height: 8, width: 8 }, legendName: { flex: 1, fontSize: 11 }, rangeRow: { flexDirection: 'row', gap: 14, justifyContent: 'flex-end', marginTop: 10 }, chart: { alignItems: 'flex-end', borderBottomWidth: 1, flexDirection: 'row', gap: 10, height: 130, justifyContent: 'center', marginTop: 8, paddingHorizontal: 17 }, bar: { borderTopLeftRadius: 4, borderTopRightRadius: 4, minWidth: 14, width: 23 }, months: { flexDirection: 'row', justifyContent: 'space-around', paddingTop: 7 }, overlay: { flex: 1, justifyContent: 'flex-end' }, sheet: { borderTopLeftRadius: 27, borderTopRightRadius: 27, padding: 21 }, loading: { alignItems: 'center', paddingVertical: 45 }, loadingGlyph: { fontSize: 29, marginBottom: 12 }, insightText: { fontSize: 13, lineHeight: 21, marginTop: 17 }, takeaway: { borderRadius: 14, gap: 5, marginVertical: 17, padding: 13 }, closeInsight: { alignItems: 'center', borderRadius: 13, padding: 13 } });
