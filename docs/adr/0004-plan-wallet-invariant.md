...
Kita menetapkan invariant: **setiap angka uang di Budget plan hanyalah salah satu dari dua hal — target Pengeluaran (rencana, ditulis manual) atau turunan transaksi (realita). Tidak ada angka ketiga.** Saldo wallet, realisasi Pendapatan, progress Pengeluaran, saldo tersedia, dan spare budget semuanya dihitung dari tabel transaksi yang sama, sehingga plan dan dompet tidak mungkin berbeda (sinkron by construction, bukan dijaga manual).
