...
Slot token & peran. Nilai diambil dari prototype Figma Make (`design-figma-make/src/index.css` dan `category.css`) yang merupakan **sumber kebenaran visual saat ini**. File ini untuk developer (React Native) dan design agent; `DESIGN.md` menjelaskan cara pakainya.
...
- Sumber: `design-figma-make/src/index.css`, `design-figma-make/src/category.css`, `design-figma-make/src/App.tsx`
